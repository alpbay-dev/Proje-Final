...
def create_fasta_from_sequences(sequences, output_filepath: str, align: bool = True) -> str:
    ...
    # Path for the unaligned FASTA file (kept with its original name)
    ...
    logger.info(f"Aligned FASTA file created: {final_aligned_filepath}")
    return final_aligned_filepath